...
```ts
export const tokens = {
  colors: ['#000000', '#3c4f69', '#533afd', '#061b31', '#ffffff', '#0a2540', '#50617a', '#6b59fe', '#64748d', '#707f98', '#e8e9ff', '#0000ee', '#7f7dfc', '#1a2c44'],
  fonts: ['[object Object]', '[object Object]', '[object Object]', '[object Object]'],
  radii: ['1', '4', '8', '12', '16', '28'],
  shadows: ['rgba(10, 37, 64, 0.22) 0px -1.854px 4.634px 0px inset', 'rgba(0, 0, 0, 0.1) 0px 2px 5px 0px', 'rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px'],
};
```
## Sections
- cta
