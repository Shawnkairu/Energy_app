...
> Extracted from `https://stripe.com` on April 30, 2026
> 10912 elements analyzed across 7 pages
...
|------|-----|-----|-----|-------------|
| Primary | `#6b59fe` | rgb(107, 89, 254) | hsl(247, 99%, 67%) | 566 |
| Secondary | `#e8e9ff` | rgb(232, 233, 255) | hsl(237, 100%, 95%) | 236 |
| Accent | `#ffe0d1` | rgb(255, 224, 209) | hsl(20, 100%, 91%) | 7 |

### Neutral Colors

| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#000000` | hsl(0, 0%, 0%) | 6647 |
| `#ffffff` | hsl(0, 0%, 100%) | 1055 |
| `#50617a` | hsl(216, 21%, 40%) | 832 |
| `#64748d` | hsl(217, 17%, 47%) | 448 |
| `#707f98` | hsl(218, 16%, 52%) | 322 |
| `#7d8ba4` | hsl(218, 18%, 57%) | 28 |
| `#171717` | hsl(0, 0%, 9%) | 16 |
| `#f5f5f5` | hsl(0, 0%, 96%) | 6 |
...
Used on large-area elements: `#ffffff`, `#e5edf5`, `#f8fafd`, `#302554`, `#5d0252`, `#fffafd`, `#0d1738`, `#122054`, `#000000`, `#e6ebf1`, `#f2f7fe`, `#f6f9fc`, `#0c2e4e`, `#fafbfd`, `#635bff`, `#004377`
...
```css
background-image: linear-gradient(rgba(0, 0, 0, 0), rgba(236, 239, 241, 0.8));
```

```css
background-image: linear-gradient(rgba(66, 71, 112, 0.09), rgba(66, 71, 112, 0.09) 50%, rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0));
```

```css
background-image: radial-gradient(66.35% 66.35%, rgb(255, 255, 255) 0px, rgba(255, 255, 255, 0) 100%), none;
```

```css
background-image: linear-gradient(270deg, rgb(0, 115, 230) 4.91%, rgb(22, 203, 225) 21.6%, rgb(72, 164, 237) 40.82%, rgb(99, 91, 255) 60.04%, rgb(153, 102, 255) 80.27%, rgb(209, 135, 255) 96.97%);
```
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#000000` | text, border, background | 6647 |
| `#3c4f69` | text, border, background | 5629 |
| `#533afd` | text, border, background | 3448 |
| `#061b31` | text, border, background | 1297 |
| `#ffffff` | background, text, border | 1055 |
| `#0a2540` | text, border | 922 |
| `#50617a` | text, border | 832 |
| `#6b59fe` | text, border, background | 566 |
| `#64748d` | text, border | 448 |
| `#707f98` | text, border | 322 |
| `#e8e9ff` | background, border | 236 |
| `#0000ee` | text, border | 196 |
| `#7f7dfc` | text, border, background | 74 |
| `#1a2c44` | text, border | 72 |
| `#ff6118` | text, border | 65 |
| `#273951` | text, border | 64 |
| `#7389ff` | text, border | 60 |
| `#b9b9f9` | border | 44 |
| `#2874ad` | text, border | 44 |
| `#20033c` | text, border | 32 |
| `#7d8ba4` | text, border | 28 |
| `#15be53` | background, border | 28 |
| `#d6d9fc` | border | 20 |
| `#a51d85` | text, border | 20 |
| `#ffd7ef` | border, background | 19 |
| `#171717` | text, border | 16 |
| `#5b6bff` | text, border | 16 |
| `#00b261` | text, border | 16 |
| `#4f2055` | text, border | 16 |
| `#839bc8` | text, border | 16 |

## Typography

### Font Families

- **sohne-var** — used for all (10578 elements)
- **Times New Roman** — used for body (248 elements)
- **SourceCodePro** — used for body (73 elements)
- **Arial** — used for all (12 elements)
...
|-----------|------------|--------|-------------|----------------|---------|
| 56px | 3.5rem | 300 | 57.68px | -1.4px | h2, h1 |
| 48px | 3rem | 300 | 55.2px | -0.96px | h1, em, span, p |
| 38px | 2.375rem | 500 | 48px | -0.2px | h1 |
| 32px | 2rem | 300 | 35.2px | -0.64px | h2, p, h3, span |
| 26px | 1.625rem | 400 | normal | normal | div, h3, span, q |
| 24px | 1.5rem | 400 | normal | -0.72px | div, h1 |
| 23px | 1.4375rem | 500 | 28px | normal | h1 |
...
| 15px | 0.9375rem | 400 | 21px | normal | div, a, svg, g |
| 14px | 0.875rem | 400 | 14px | normal | button, svg, path, a |
| 13.3333px | 0.8333rem | 400 | normal | normal | button, svg, rect |
...
h1 { font-size: 38px; font-weight: 500; line-height: 48px; }
h2 { font-size: 32px; font-weight: 300; line-height: 35.2px; }
h3 { font-size: 26px; font-weight: 400; line-height: normal; }
h1 { font-size: 24px; font-weight: 400; line-height: normal; }
h1 { font-size: 23px; font-weight: 500; line-height: 28px; }
h3 { font-size: 22px; font-weight: 300; line-height: 24.2px; }
h2 { font-size: 18px; font-weight: 300; line-height: 25.2px; }
h4 { font-size: 16px; font-weight: 400; line-height: normal; }
h1 { font-size: 15px; font-weight: 400; line-height: 21px; }
h1 { font-size: 14px; font-weight: 400; line-height: 14px; }
h3 { font-size: 13px; font-weight: 400; line-height: normal; }
```
...
`400` (5923x), `300` (4171x), `425` (691x), `500` (121x), `700` (6x)
...
**xl** — blur: 27px
```css
box-shadow: rgba(50, 50, 93, 0.25) 0px 13.5px 27px -12.4px;
```
...
**xl** — blur: 32px
```css
box-shadow: rgba(0, 0, 0, 0.06) 0px -16px 32px -12px, rgba(0, 0, 0, 0.04) 0px -8px 16px 0px;
```
...
--columnPaddingNone: 0;
--fixedNavScrollMargin: calc(60px + 48px);
...
--inputFont: 300 15px/1.6 "sohne-var","Helvetica Neue","Arial",sans-serif;
...
--fontWeightLight: 200;
--ctaFont: 425 15px/1.6 "sohne-var","Helvetica Neue","Arial",sans-serif;
--sourceCodeFont: 500 14px/1.714285714 "SourceCodePro";
...
--gutterWidth: calc(calc(100vw - 0px)/2 - 1080px/2);
--angleNormal: -6deg;
--angleStrong: -12deg;
--viewportWidthMedium: 600;
--columnCountMax: 4;
--columnMaxWidth: calc(1080px*0.25);
--viewportScale: calc(calc(100vw - 0px)/1112);
--angleNormalSin: 0.106;
--fixedNavHeight: 60px;
--scrollbarWidth: 0px;
--copyMaxWidth: calc(calc(1080px*0.25)*3);
--modalZIndex: 999999;
--layoutWidthMax: 1080px;
--layoutWidth: 1080px;
--columnWidth: calc(1080px/4);
--windowWidth: calc(100vw - 0px);
```
...
| lg | 1020px | min-width |
| lg | 1069px | max-width |
| 1111px | 1111px | max-width |
| 1112px | 1112px | min-width |
...
**Easing functions:** `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`, `[object Object]`

**Durations:** `0.24s`, `0.25s`, `0.3s`, `0.15s`, `0.1s`, `0.8s`, `0.6s`, `1s`, `0.5s`, `0.4s`, `1.2s`, `0s`, `0.12s`, `0.2s`, `0.35s`
...
**UniversalChatTypingBubbleBounce**
```css
@keyframes UniversalChatTypingBubbleBounce {
  0%, 100% { animation-timing-function: ease-out; transform: translateY(2px); }
  50% { animation-timing-function: ease-in-out; transform: translateY(-2.5px); }
}
```
...
**656 grid containers** and **1392 flex containers** detected.
...
**Gap values:** `0px 10px`, `0px 14px`, `0px normal`, `10px`, `10px normal`, `12px`, `12px 0px`, `12px normal`, `13.824px`, `14px`, `16px`, `16px 32px`, `16px normal`, `1px`, `20px normal`, `24px`, `24px normal`, `26px`, `28px`, `2px`, `3.2px`, `32px`, `32px 16px`, `32px normal`, `3px`, `40px`, `40px 16px`, `40px normal`, `48px`, `48px 0px`, `48px normal`, `4px`, `4px 32px`, `4px normal`, `56px 16px`, `5px`, `64px`, `64px normal`, `6px`, `6px normal`, `7px normal`, `80px`, `8px`, `8px 16px`, `8px normal`, `96px`, `96px normal`, `normal 10px`, `normal 12px`, `normal 16px`, `normal 20px`, `normal 24px`, `normal 40px`, `normal 4px`, `normal 6px`, `normal 7px`, `normal 8px`
...
|----------|-----------|-------------|-------------|-----------|-------------|
| mobile (375px) | 16px | Yes | 12 | Yes | 20197px |
| tablet (768px) | 16px | Yes | 12 | Yes | 14910px |
| desktop (1280px) | 16px | Yes | 12 | No | 14482px |
| wide (1920px) | 16px | Yes | 12 | No | 14723px |

### Breakpoint Changes

**375px → 768px** (mobile → tablet):
- H1 size: `34px` → `40px`
- Page height: `20197px` → `14910px`

**768px → 1280px** (tablet → desktop):
- H1 size: `40px` → `48px`
- Hamburger menu: `shown` → `hidden`
- Page height: `14910px` → `14482px`

**1280px → 1920px** (desktop → wide):
- Page height: `14482px` → `14723px`
...
```css
/* Hover */
color: rgb(72, 90, 114) → rgb(91, 108, 132);
border-color: rgb(72, 90, 114) → rgb(91, 108, 132);
outline: rgb(72, 90, 114) none 3px → rgb(91, 108, 132) none 3px;
```
```css
/* Focus */
color: rgb(72, 90, 114) → rgb(34, 53, 76);
border-color: rgb(72, 90, 114) → rgb(34, 53, 76);
outline: rgb(72, 90, 114) none 3px → rgb(83, 58, 253) solid 2px;
```

**"Developers"**
```css
/* Focus */
color: rgb(100, 116, 141) → rgb(12, 33, 55);
border-color: rgb(100, 116, 141) → rgb(12, 33, 55);
...
**Overall Score: 86%** — 51 passing, 8 failing color pairs

### Failing Color Pairs

| Foreground | Background | Ratio | Level | Used On |
|------------|------------|-------|-------|---------|
| `#ffffff` | `#e3ecf7` | 1.19:1 | FAIL | h4 (6x) |
...
- 8 WCAG contrast failures
- 52% of CSS is unused — consider purging
- 6122 duplicate CSS declarations

## Gradients

**26 unique gradients** detected.
...
|-------|-------|----------|
| modal | 999999,2147483639 | span.P.o.r.t.a.l.T.o.o.l.t.i.p.I.t.e.m._._.t.o.o.l.t.i.p, span.P.o.r.t.a.l.T.o.o.l.t.i.p.I.t.e.m._._.t.o.o.l.t.i.p, span.P.o.r.t.a.l.T.o.o.l.t.i.p.I.t.e.m._._.t.o.o.l.t.i.p |
| dropdown | 100,999 | header.S.i.t.e.H.e.a.d.e.r. .S.i.t.e.H.e.a.d.e.r.-.-.n.o.T.r.a.n.s.i.t.i.o.n.s. .S.i.t.e.H.e.a.d.e.r.-.-.r.e.f.r.e.s.h.e.d. .S.i.t.e.H.e.a.d.e.r.-.-.h.a.s.C.o.n.t.a.c.t.S.a.l.e.s. .f.l.a.v.o.r.-.-.C.h.r.o.m.a. .a.c.c.e.n.t.-.-.B.l.u.r.p.l.e. .S.i.t.e.H.e.a.d.e.r.-.-.h.a.s.G.u.i.d.e.s, nav.F.i.x.e.d.N.a.v. .P.r.i.c.i.n.g.S.t.i.c.k.y.N.a.v._._.f.i.x.e.d.N.a.v, div.P.r.i.c.i.n.g.B.o.t.t.o.m.S.h.e.e.t.N.a.v._._.n.a.v |
| sticky | 99,99 | div.U.n.i.v.e.r.s.a.l.C.h.a.t.I.n.i.t.i.a.l.i.z.e.r._._.c.t.a, div.U.n.i.v.e.r.s.a.l.C.h.a.t.I.n.i.t.i.a.l.i.z.e.r._._.c.t.a |
| base | -1,4 | div.n.a.v.i.g.a.t.i.o.n.-.m.e.n.u._._.b.a.c.k.g.r.o.u.n.d, div.s.e.s.s.i.o.n.s.-.k.e.y.n.o.t.e.-.s.p.e.a.k.e.r.-.i.m.a.g.e, div.s.e.s.s.i.o.n.s.-.k.e.y.n.o.t.e.-.s.p.e.a.k.e.r.-.i.m.a.g.e |
...
**133 unique SVG icons** detected. Dominant style: **filled**.
...
|---------|-------|------------|
| thumbnail | 59 | objectFit: fill, borderRadius: 0px, shape: square |
...
**Aspect ratios:** 4.18:1 (36x), 1:1 (15x), 21:9 (11x), 3:4 (9x), 4:3 (6x), 9:16 (4x), 2:3 (4x), 16:9 (2x)
...
- **custom** (156 uses) — `cubic-bezier(0.45, 0.05, 0.55, 0.95)`, `cubic-bezier(0.4, 0, 0.2, 1)`, `cubic-bezier(0.6, 0, 0.2, 0.5)`
- **ease-out** (1423 uses) — `cubic-bezier(0.25, 1, 0.5, 1)`, `cubic-bezier(0.165, 0.84, 0.44, 1)`, `cubic-bezier(0.16, 1, 0.3, 1)`
- **ease-in-out** (19 uses) — `ease`
- **linear** (256 uses) — `linear`
- **steps** (28 uses) — `steps(1)`, `steps(1, start)`

### Keyframes In Use

| name | kind | properties | uses |
|---|---|---|---|
| `refreshed-nav-hover-arrow-out` | fade | opacity | 163 |
...
|---|---|---|
| default | 207 | Accept and optimize payments globally—on |
...
Reading order (top→bottom): cta → nav → pricing-table → testimonial → pricing-table → testimonial → stats → pricing-table → testimonial → testimonial → pricing-table → nav → gallery → pricing-table → nav → pricing-table → pricing-table → pricing-table → gallery → cta → nav → nav → footer
...
**Label:** `flat-illustration` (confidence 0.217)
**Counts:** total 92, svg 43, icon 1, screenshot-like 0, photo-like 5
...
|-----------|-----|--------|
| pricing | https://stripe.com/pricing | ok |
