...
> Extracted from `https://stripe.com` on April 22, 2026
> 2413 elements analyzed
...
| Secondary | `#e8e9ff` | rgb(232, 233, 255) | hsl(237, 100%, 95%) | 58 |
...
| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#000000` | hsl(0, 0%, 0%) | 2634 |
| `#50617a` | hsl(216, 21%, 40%) | 318 |
...
Used on large-area elements: `#ffffff`, `#e5edf5`, `#f8fafd`, `#0d1738`, `#f2f7fe`, `#e6ebf1`
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#000000` | text, border, background | 2634 |
| `#533afd` | text, border, background | 899 |
| `#50617a` | text, border | 318 |
...
- **sohne-var** — used for all (2413 elements)
...
- 6021 duplicate CSS declarations
...
**81 unique SVG icons** detected. Dominant style: **filled**.
...
- **custom** (49 uses) — `cubic-bezier(0.45, 0.05, 0.55, 0.95)`, `cubic-bezier(0.4, 0, 0.2, 1)`, `cubic-bezier(0.6, 0, 0.2, 0.5)`
- **ease-out** (555 uses) — `cubic-bezier(0.25, 1, 0.5, 1)`, `cubic-bezier(0.165, 0.84, 0.44, 1)`, `cubic-bezier(0.16, 1, 0.3, 1)`
...
|---|---|---|
| default | 183 | Accept and optimize payments globally—on |
...
**Counts:** total 75, svg 43, icon 1, screenshot-like 0, photo-like 5
