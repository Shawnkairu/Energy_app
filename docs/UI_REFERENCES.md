...
![e.mappa official color palette and character](./ui-references/emappa-official-color-palette-character.png)
...
![Stripe dashboard overview](./ui-references/stripe-dashboard-overview.png)
...
![e.mappa system relationship map](./ui-references/emappa-system-relationship-map.png)
...
![Tesla Powerwall dark energy chart](./ui-references/tesla-powerwall-dark-energy.png)

Tesla reference: energy status, sparse controls, large calm numbers, and premium charting adapted into light surfaces.

![Enphase energy flow](./ui-references/enphase-energy-flow.png)
...
![Robinhood dark finance chart](./ui-references/robinhood-dark-finance-chart.png)
