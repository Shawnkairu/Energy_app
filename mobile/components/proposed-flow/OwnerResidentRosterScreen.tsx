...
import { OwnerBriefCard, OwnerMetricGrid, OwnerScreenShell } from "../owner/OwnerShared";
      ...
      {() => (
        <>
          ...
          <GlassCard>
            ...
            <Text style={{ color: colors.text, fontSize: 17, fontWeight: "600", marginTop: 6 }}>Most recent waves</Text>
            {[
              ...
              >
                <Text style={{ color: colors.text, fontSize: 11.5, fontWeight: "600", flex: 1 }}>{w.wave}</Text>
                <Text style={{ color: colors.muted, fontSize: 11 }}>sent {w.sent}</Text>
                <Text style={{ color: colors.green, fontSize: 11, fontWeight: "600" }}>joined {w.joined}</Text>
              </View>
            ))}
          </GlassCard>
          <WireframeWell height={64} label="QR + shareable invite preview" />
        </>
      )}
    </OwnerScreenShell>
  );
