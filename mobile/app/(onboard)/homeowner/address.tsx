...
export default function HomeownerAddressScreen() {
  ...
  return (
    <OnboardShell
      ...
      footer={<ActionButton onPress={createHome} disabled={isCreating || isGeocoding}>{isCreating ? "Creating..." : "Continue"}</ActionButton>}
    >
      <GlassCard>
        ...
        {isGeocoding ? <Text style={styles.helper}>Geocoding address...</Text> : null}
      </GlassCard>
